...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"infinite-scroll-fav-quotes.471c644e.js":[function(require,module,exports) {
var define;
...
parcelRequire = function (e, r, t, n) {
  ...
  "pyFg": [function (require, module, exports) {
    ...
    function k(t) {
      return "object" == _typeof(t) && null !== t && t.$$typeof === e;
    }
    function C(e) {
      var t = {
        "=": "=0",
    ...
    var g = /\/+/g;
    function j(e, t) {
      return "object" == _typeof(e) && null !== e && null != e.key ? C("" + e.key) : t.toString(36);
    }
  ...
  "x9cO": [function (require, module, exports) {
    ...
    if ("function" == typeof y) h = function h() {
      y(L);
    };else if ("undefined" != typeof MessageChannel) {
      var M = new MessageChannel(),
        F = M.port2;
      M.port1.onmessage = L, h = function h() {
        F.postMessage(null);
      };
    } else h = function h() {
      v(L, 0);
    ...
    exports.unstable_IdlePriority = 5, exports.unstable_ImmediatePriority = 1, exports.unstable_LowPriority = 4, exports.unstable_NormalPriority = 3, exports.unstable_Profiling = null, exports.unstable_UserBlockingPriority = 2, exports.unstable_cancelCallback = function (e) {
      ...
      switch ("object" == _typeof(a) && null !== a ? a = "number" == typeof (a = a.delay) && 0 < a ? o + a : o : a = o, t) {
        case 1:
          var l = -1;
          break;
        case 2:
  ...
  "jF7N": [function (require, module, exports) {
    ...
    function fu(e, n, t, r) {
      ...
      var a = n.contextType;
      "object" == _typeof(a) && null !== a ? l.context = ja(a) : (a = Gl(n) ? Yl : ql.current, l.context = Xl(e, a)), l.state = e.memoizedState, "function" == typeof (a = n.getDerivedStateFromProps) && (uu(e, n, a, t), l.state = e.memoizedState), "function" == typeof n.getDerivedStateFromProps || "function" == typeof l.getSnapshotBeforeUpdate || "function" != typeof l.UNSAFE_componentWillMount && "function" != typeof l.componentWillMount || (n = l.state, "function" == typeof l.componentWillMount && l.componentWillMount(), "function" == typeof l.UNSAFE_componentWillMount && l.UNSAFE_componentWillMount(), n !== l.state && ou.enqueueReplaceState(l, l.state, null), ru(e, t, l, r), l.state = e.memoizedState), "function" == typeof l.componentDidMount && (e.flags |= 4194308);
    }
    function du(e, n, r) {
    ...
    function hu(e) {
      ...
      function s(e, n, t, r) {
        var l = t.type;
        return l === x ? f(e, n, t.props.children, r, t.key) : null !== n && (n.elementType === l || "object" == _typeof(l) && null !== l && l.$$typeof === M && mu(l) === n.type) ? ((r = a(n, t.props)).ref = du(e, n, t), r.return = e, r) : ((r = oc(t.type, t.key, t.props, null, e.mode, r)).ref = du(e, n, t), r.return = e, r);
      }
      function c(e, n, t, r) {
              ...
              e: {
                for (var s = u.key, c = l; null !== c;) {
                  if (c.key === s) {
                    ...
                    } else if (c.elementType === s || "object" == _typeof(s) && null !== s && s.$$typeof === M && mu(s) === c.type) {
    ...
    function Ko(e, n, t, r, l) {
      ...
      if (Wa(n, l), null === n.stateNode) fi(e, n), su(n, t, r), fu(n, t, r, l), r = !0;else if (null === e) {
        ...
        var i = u.context,
          s = t.contextType;
        "object" == _typeof(s) && null !== s ? s = ja(s) : s = Xl(n, s = Gl(t) ? Yl : ql.current);
        ...
        u = n.stateNode, Za(e, n), o = n.memoizedProps, s = n.type === n.elementType ? o : Oa(n.type, o), u.props = s, f = n.pendingProps, d = u.context, "object" == _typeof(i = t.contextType) && null !== i ? i = ja(i) : i = Xl(n, i = Gl(t) ? Yl : ql.current);
    ...
    }, Jo = function Jo() {}, ei = function ei(e, n, t, r) {
      var a = e.memoizedProps;
      if (a !== r) {
        ...
        try {
          ...
          e: {
            var u = e,
              ...
              i = r,
              s = n;
            if (n = ns, i.flags |= 32768, null !== s && "object" == _typeof(s) && "function" == typeof s.then) {
              var c = s,
                f = i,
                d = f.tag;
    ...
    qi = function qi(e, n, r) {
      ...
      switch (n.lanes = 0, n.tag) {
        case 2:
          ...
          var u = Wu();
          return n.flags |= 1, "object" == _typeof(a) && null !== a && "function" == typeof a.render && void 0 === a.$$typeof ? (n.tag = 1, n.memoizedState = null, n.updateQueue = null, Gl(l) ? (u = !0, na(n)) : u = !1, n.memoizedState = null !== a.state && void 0 !== a.state ? a.state : null, Ga(n), a.updater = ou, n.stateNode = a, a._reactInternals = n, fu(n, l, e, r), n = Yo(null, n, l, !0, u, r)) : (n.tag = 0, Ea && u && ka(n), Bo(null, n, a, r), n = n.child), n;
        case 16:
          l = n.elementType;
          e: {
  ...
  "U1bq": [function (require, module, exports) {
    "use strict";
  ...
  "OHMF": [function (require, module, exports) {
    module.exports = "/tweet.97d34ed0.png";
  }, {}],
  "Z1ID": [function (require, module, exports) {
    module.exports = "/copy.d30c31a3.png";
  }, {}],
  "F7ib": [function (require, module, exports) {
    ...
    var e = n(require("../assets/tweet.png")),
      t = n(require("../assets/copy.png"));
    function n(e) {
    ...
    var c = require("react"),
      a = function a(n) {
        ...
        }, c.createElement("h1", null, a), c.createElement("span", null, "~", o)), c.createElement("hr", null), c.createElement("div", {
          className: "buttons"
        }, c.createElement("img", {
          onClick: function onClick() {
            var e = "".concat(a, " ~").concat(o),
              t = "https://twitter.com/intent/tweet?text=".concat(encodeURIComponent(e));
            window.open(t, "_blank", "width=550,height=350");
          },
          src: e.default,
          alt: "Tweet",
          className: "tweet"
    ...
    "react": "HdMw",
    "../assets/tweet.png": "OHMF",
    "../assets/copy.png": "Z1ID"
  }],
  "bXur": [function (require, module, exports) {
    "use strict";
    ...
    var e = require("react"),
      t = function t() {
        return e.createElement("div", {
          ...
          className: "shimmar-content"
        }), e.createElement("div", {
          className: "shimmar-author"
        }));
      },
      r = exports.default = t;
  }, {
  ...
  "wPSe": [function (require, module, exports) {
    function t(r) {
    ...
    function r() {
      ...
      function S(r, e) {
        function n(o, a, c, u) {
          ...
          if ("throw" !== f.type) {
            var s = f.arg,
              l = s.value;
            return l && "object" == t(l) && i.call(l, "__await") ? e.resolve(l.__await).then(function (t) {
              n("next", t, c, u);
            }, function (t) {
              n("throw", t, c, u);
      ...
      function G(t, r) {
        var n = r.method,
          o = t.iterator[n];
        if (o === e) return r.delegate = null, "throw" === n && t.iterator.return && (r.method = "return", r.arg = e, G(t, r), "throw" === r.method) || "return" !== n && (r.method = "throw", r.arg = new TypeError("The iterator does not provide a '" + n + "' method")), m;
      ...
      return b.prototype = x, a(_, "constructor", {
        ...
        value: b,
        configurable: !0
      }), b.displayName = l(x, s, "GeneratorFunction"), n.isGeneratorFunction = function (t) {
        var r = "function" == typeof t && t.constructor;
        return !!r && (r === b || "GeneratorFunction" === (r.displayName || r.name));
      }, n.mark = function (t) {
        return Object.setPrototypeOf ? Object.setPrototypeOf(t, x) : (t.__proto__ = x, l(t, s, "GeneratorFunction")), t.prototype = Object.create(_), t;
      }, n.awrap = function (t) {
        return {
          __await: t
        };
      }, O(S.prototype), l(S.prototype, f, function () {
        return this;
      }), n.AsyncIterator = S, n.async = function (t, r, e, o, i) {
        void 0 === i && (i = Promise);
        var a = new S(h(t, r, e, o), i);
        return n.isGeneratorFunction(r) ? a : a.next().then(function (t) {
          return t.done ? t.value : a.next();
        });
      }, O(_), l(_, s, "Generator"), l(_, u, function () {
        return this;
        ...
        reset: function reset(t) {
          if (this.prev = 0, this.next = 0, this.sent = this._sent = e, this.done = !1, this.delegate = null, this.method = "next", this.arg = e, this.tryEntries.forEach(N), !t) for (var r in this) "t" === r.charAt(0) && i.call(this, r) && !isNaN(+r.slice(1)) && (this[r] = e);
        },
        stop: function stop() {
          this.done = !0;
        ...
        var t = n(r().mark(function t(e) {
          ...
          return r().wrap(function (t) {
            for (;;) switch (t.prev = t.next) {
              case 0:
                return n = "https://api.quotable.io/quotes?skip=".concat(20 * (e - 1)), t.prev = 1, t.next = 4, fetch(n, o);
              case 4:
                return i = t.sent, t.next = 7, i.json();
              case 7:
                return a = t.sent, t.abrupt("return", a.results);
              case 11:
  ...
  "P4os": [function (require, module, exports) {
    "use strict";
      ...
      return u(s, t.Component), e(s, [{
        ...
        value: function value() {
          ...
          if (this.props.useWindow) {
            var s = document.documentElement || document.body.parentNode || document.body,
              n = void 0 !== t.pageYOffset ? t.pageYOffset : s.scrollTop;
            r = this.props.isReverse ? n : this.calculateOffset(e, n);
          } else r = this.props.isReverse ? o.scrollTop : e.scrollHeight - o.scrollTop - o.clientHeight;
          r < Number(this.props.threshold) && e && null !== e.offsetParent && (this.detachScrollListener(), this.beforeScrollHeight = o.scrollHeight, this.beforeScrollTop = o.scrollTop, "function" == typeof this.props.loadMore && (this.props.loadMore(this.pageLoaded += 1), this.loadMore = !0));
        }
      }, {
        key: "calculateOffset",
        ...
        value: function value() {
          var e = this,
            ...
            p = (t.threshold, t.useCapture, t.useWindow, t.getScrollParent, i(t, ["children", "element", "hasMore", "initialLoad", "isReverse", "loader", "loadMore", "pageStart", "ref", "threshold", "useCapture", "useWindow", "getScrollParent"]));
          p.ref = function (t) {
            e.scrollComponent = t, u && u(t);
          };
          var h = [r];
          return n && (a ? l ? h.unshift(a) : h.push(a) : this.defaultLoader && (l ? h.unshift(this.defaultLoader) : h.push(this.defaultLoader))), o.default.createElement(s, p, h);
        }
      }]), s;
    }();
    p.propTypes = {
  ...
  "r9Dv": [function (require, module, exports) {
    module.exports = require("./dist/InfiniteScroll");
  }, {
    "./dist/InfiniteScroll": "P4os"
  }],
  "Focm": [function (require, module, exports) {
    ...
    function r() {
      ...
      var j = E.prototype = w.prototype = Object.create(L);
      function O(t) {
        ["next", "throw", "return"].forEach(function (r) {
          s(t, r, function (t) {
            return this._invoke(r, t);
      ...
      function _(r, e) {
        function n(o, a, c, u) {
          ...
          if ("throw" !== l.type) {
            var f = l.arg,
              s = f.value;
            return s && "object" == t(s) && i.call(s, "__await") ? e.resolve(s.__await).then(function (t) {
              n("next", t, c, u);
            }, function (t) {
              n("throw", t, c, u);
      ...
      function A(t, r, n) {
        ...
        return function (i, a) {
          ...
          for (n.method = i, n.arg = a;;) {
            ...
            var l = y(t, r, n);
            if ("normal" === l.type) {
              if (o = n.done ? d : v, l.arg === g) continue;
              return {
                value: l.arg,
                done: n.done
              };
      ...
      return b.prototype = E, a(j, "constructor", {
        value: E,
        configurable: !0
      }), a(E, "constructor", {
        value: b,
        configurable: !0
      }), b.displayName = s(E, f, "GeneratorFunction"), n.isGeneratorFunction = function (t) {
        var r = "function" == typeof t && t.constructor;
        return !!r && (r === b || "GeneratorFunction" === (r.displayName || r.name));
      }, n.mark = function (t) {
        return Object.setPrototypeOf ? Object.setPrototypeOf(t, E) : (t.__proto__ = E, s(t, f, "GeneratorFunction")), t.prototype = Object.create(j), t;
      }, n.awrap = function (t) {
        return {
          __await: t
        };
      }, O(_.prototype), s(_.prototype, l, function () {
        return this;
      ...
      }, O(j), s(j, f, "Generator"), s(j, u, function () {
        return this;
      ...
      }, n.values = G, P.prototype = {
        constructor: P,
        reset: function reset(t) {
          if (this.prev = 0, this.next = 0, this.sent = this._sent = e, this.done = !1, this.delegate = null, this.method = "next", this.arg = e, this.tryEntries.forEach(I), !t) for (var r in this) "t" === r.charAt(0) && i.call(this, r) && !isNaN(+r.slice(1)) && (this[r] = e);
        },
        stop: function stop() {
          this.done = !0;
          var t = this.tryEntries[0].completion;
    ...
    var p = require("react"),
      v = p.useState,
      m = p.useEffect,
      d = require("react-dom/client"),
      g = require("./components/Card").default,
      w = require("./components/Shimmar").default,
      b = require("./fetchAPI"),
      E = require("react-infinite-scroller"),
      L = function L() {
        var t = u(v([]), 2),
          n = t[0],
          o = t[1],
        ...
        return 0 === n.length ? p.createElement("div", {
          className: "container"
        }, p.createElement(w, null), p.createElement(w, null), p.createElement(w, null), p.createElement(w, null), p.createElement(w, null)) : p.createElement(E, {
          pageStart: 0,
          loadMore: y,
          hasMore: a,
          loader: p.createElement("div", {
            className: "loader",
            key: 0
          }, "Loading ...")
        }, p.createElement("div", {
      ...
      x = d.createRoot(document.getElementById("root"));
    x.render(p.createElement(L, null));
  }, {
    "react": "HdMw",
    "react-dom/client": "U1bq",
    "./components/Card": "F7ib",
    "./components/Shimmar": "bXur",
    "./fetchAPI": "wPSe",
    "react-infinite-scroller": "r9Dv"
  }]
}, {}, ["Focm"], null);
},{}]